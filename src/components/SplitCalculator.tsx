    ...
    <div className="flex flex-col lg:flex-row gap-3 flex-1 lg:overflow-hidden">
      ...
      <div className="lg:w-3/5 flex flex-col bg-white dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-800 lg:max-h-full lg:overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-2 px-4 py-3 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
          ...
          <label
            htmlFor="jsonUpload"
            className="ml-auto max-w-80 sm:max-w-full flex items-center justify-center gap-1.5 px-3 py-1.5 bg-[hsl(194,100%,65%)] hover:bg-[hsl(194,100%,55%)] text-white text-sm rounded transition-colors cursor-pointer"
          >
            <Upload size={16} />
            Upload
          </label>
        ...
        <div className="flex-1 overflow-y-auto lg:max-h-[calc(100vh-220px)] p-4 space-y-3">
          ...
          <div className="space-y-2 pt-2">
            <PDFDownloadLink
              ...
              className="flex items-center justify-center gap-2 w-full bg-[hsl(194,100%,65%)] hover:bg-[hsl(194,100%,55%)] text-white px-4 py-2 text-sm rounded transition-colors"
            >
              <Download size={16} />
              Download PDF
            </PDFDownloadLink>
